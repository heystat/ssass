...
############################.
krcd = 'KR6079161B68'
update_issue(krcd, 상환일 = as.Date('2026-06-08'), 상환율 = 1.107456, 과세방법='발생분과세')
update_issue(krcd, 과세방법='발생분과세', CLASS='aaa')
...
############################.
krcd = 'KR6079161C75'
update_issue(krcd, 상환일 = as.Date('2027-07-21'), 상환율 = 1.134320118586, 과세방법='발생분과세')
update_issue(krcd, 과세방법='발생분과세', CLASS='aaa')
...
############################.
krcd = 'KR6079162E31'
update_issue(krcd, 상환일 = as.Date('2026-03-15'))
...
krcd = 'KR6009411B71'
update_issue(krcd)
update_issue(krcd, 상환일 = as.Date('2027-07-19'), 주의사항 = '상환일 3년 지연 예상')
...
############################.
krcd = 'KR6003622DC8'
update_issue(krcd, 상환일 = as.Date('2025-12-05'), 상환율 = 1.061598, CLASS='ccc')
...
############################.
krcd = 'KR103502G990'
update_issue(krcd, 신용GD = 'A', CLASS='aaa')
...
############################.
krcd = 'KR6109961D71'
update_issue(krcd, 상환일 = as.Date('2025-01-25'), 상환율 = 1.030953, CLASS='ccc')
...
############################.
krcd = 'KR6170901B86'
update_issue(krcd, 상환일 = as.Date('2024-08-03'), 상환율 = 1.030414, CLASS='bbb')
...
############################.
krcd = 'KR6018001D68'
update_issue(krcd, 상환일 = as.Date('2024-12-13'), 상환율 = 1.046429, CLASS='aaa')
...
############################.
krcd = 'KR6143211D60'
update_issue(krcd, 상환일 = as.Date('2024-12-15'), 상환율 = 1.033702, CLASS='aaa')
...
############################.
krcd = 'KR6067631C64'
update_issue(krcd, 상환일 = as.Date('2024-06-15'), 상환율 = 1.040707, CLASS='aaa')
...
############################.
krcd = 'KR6086891DC9'
update_issue(krcd, 상환일 = as.Date('2025-12-22'), 상환율 = 1.041794, CLASS='bbb')
...
############################.
krcd = 'KR6080721D34'
update_issue(krcd, 상환일 = as.Date('2024-09-17'), 상환율 = 1.046429, CLASS='ccc')
...
############################.
krcd = 'KR6245621D59'
update_issue(krcd, 상환일 = as.Date('2024-05-11'), 상환율 = 1.030681, CLASS='aaa')
...
##////////////////////////////////////////////////////End of Documents.
>>>>>>> 08b33f8c7301b4f50b1ce371560a99aec9e7cd7f
